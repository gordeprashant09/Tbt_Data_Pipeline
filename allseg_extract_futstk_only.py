...
INSTRUMENTS   = {"FUTSTK"}  # FUTSTK-only fast path
COMPRESSION   = "zstd"
TOKEN_LENGTH  = 5
...
SHARED_SKIP_INSTRUMENTS = set()  # FUTSTK-only mode — nothing to skip
...
def main():
    ...
    source_root    = Path(f"/mnt/historical_data_2/tbt_data/raw_data/{date}")
    ...
    print("=" * 65)
    print("[INFO] FUTSTK-ONLY FAST PIPELINE — zstd")
    ...
    if passed:
        print(f"\n[SUCCESS] {date} FUTSTK extraction complete.")
